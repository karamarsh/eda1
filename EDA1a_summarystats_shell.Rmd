...
```{r boro_class_table}
table(housing$Boro, housing$Class)
```
...
```{r}
housing$zValuePerSqFt <- (housing$ValuePerSqFt - mean(housing$ValuePerSqFt))/
  sd(housing$ValuePerSqFt)
...
housing$zValuePerSqFt[housing$zValuePerSqFt > 2.5]
